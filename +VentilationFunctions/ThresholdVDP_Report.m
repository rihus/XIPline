...
function ThresholdVDP_Report(Ventilation, Proton, MainInput)
    ...
    settings = {MainInput.Scanner,MainInput.ScannerSoftware,MainInput.SequenceType,MainInput.Recon,MainInput.AnalysisCode_hash,MainInput.denoiseXe,N4bias,'Threshold',Ventilation.HealthyRef.AgeCorrected,MainInput.ImageQuality, MainInput.Note, todayStr, MainInput.Analyst};
    % Header row
    ...
    Venthist = imread(fullfile(pptDir, char(foldername), 'TH_Histogram.png'));    
